/**
 * @file   test-streamMove.cpp
 * @brief  Test code for the streamMove() function.
 *
...
BOOST_AUTO_TEST_CASE(streamMove_fwd_overlap)
{
	...
	camoto::streamMove(data, 10, 15, 10);
...
BOOST_AUTO_TEST_CASE(streamMove_back_overlap)
{
	...
	camoto::streamMove(data, 10, 5, 10);
...
BOOST_AUTO_TEST_CASE(streamMove_fw2)
{
	...
	camoto::streamMove(data, 5, 10, 15);
...
BOOST_AUTO_TEST_CASE(streamMove_bk2)
{
	...
	camoto::streamMove(data, 10, 5, 5);
	camoto::streamMove(data, 20, 10, 4);
